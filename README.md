...
| `SSH_HOST` | `144.124.249.130` | IP адрес сервера |
...
| `ALLOWED_HOSTS` | IP или домен | Например: `144.124.249.130,yourdomain.com` |
| `CORS_ALLOWED_ORIGINS` | Фронтенд URL | Например: `https://yourdomain.com` |

### Требования к серверу

**Сервер:** `144.124.249.130` (уже готов к работе)
...
После деплоя структура на сервере (144.124.249.130):
```
~/habit-tracker/
├── docker-compose.yml
├── .env
