...
class TestHabitSerializers:
    ...
    def test_habit_create_serializer_reward_and_related_mutually_exclusive(self, user, pleasant_habit):
    ...
    def test_habit_update_serializer(self, habit):
        ...
        data = {"action": "попить больше воды", "place": "на работе", "time": "10:00", "duration_to_complete": 40}
